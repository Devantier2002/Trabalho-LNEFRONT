                        ...
                        <li>
                            {cliente.id ?
                                <>
                                    ...
                                    <Link to="/minhasVendas" className="text-white font-bold bg-purple-800 hover:bg-purple-900 focus:ring-2 focus:outline-none focus:ring-purple-400 rounded-lg text-sm w-full sm:w-auto px-3 py-2 text-center dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-700">
                                        Minhas Compras
                                    </Link>&nbsp;&nbsp;
