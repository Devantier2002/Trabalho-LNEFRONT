...
export default function AdminDashboard() {
  const [produtosMarca, setProdutosMarca] = useState<graficoMarcaType[]>([])
  ...
  return (
    <div className="container mt-24">
      ...
      <div className="w-2/3 flex justify-between mx-auto mb-5">
        ...
        <div className="border-blue-600 border rounded p-6 w-1/3 me-3">
          <span className="bg-red-100 text-blue-800 text-xl text-center font-bold mx-auto block px-2.5 py-5 rounded dark:bg-red-900 dark:text-red-300">
            {dados.produtos}</span>
