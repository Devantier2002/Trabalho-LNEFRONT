...
import ItemOculos from './components/ItemOculos.tsx'
import type { ProdutoType } from "../utils/ProdutoType"
import { Link } from "react-router-dom"

const apiUrl = import.meta.env.VITE_API_URL

export default function AdminOculos() {
  ...
  const listaProdutos = produtos.map(produto => (
    <ItemOculos key={produto.id} produto={produto} produtos={produtos} setProdutos={setProdutos} />
  ))
